...
class TestLevelUpTo3(TestCase):
    ...
    def test_level_up_to_3_printed(self, mock_output):
        player = {'name': 'Irene', 'level': 2, 'intelligence': 0, 'HP': 10, 'position': [3, 1], 'location': 'student_lounge',
                  'chocolate': 10}
        ...
        expected = "YOU LEVELED UP TO LEVEL 3! (Stats - HP: +10, Intelligence: +200) You have now advanced to the Room 645. CAUTION: Some of the quizzes here can kill you in one shot. Your task now is to find Chris and give him the chocolates.\n"
