...
class TestLevelUpTo3(TestCase):
    ...
    def test_level_up_to_3_printed(self, mock_output):
        ...
        expected = "YOU LEVELED UP TO LEVEL 3! (Stats - HP: 20 (+10), Intelligence: 300 (+200)) You have now advanced to the Room 645. CAUTION: Some of the quizzes here can kill you in one shot. Your task now is to find Chris and give him the chocolates.\n"
