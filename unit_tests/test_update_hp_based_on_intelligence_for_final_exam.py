...
class TestUpdateHPBasedOnIntelligenceForFinalExam(TestCase):
    ...
    def test_update_hp_based_on_intelligence_for_final_exam_at_500(self):
        player = {'name': 'Irene', 'level': 1, 'intelligence': 500, 'HP': 10, 'position': [3, 1], 'location': 'tech_hub',
                  'chocolate': 0}
        update_hp_based_on_intelligence_for_final_exam(player)
        actual = player['HP']
        expected = 2
    ...
    def test_update_hp_based_on_intelligence_for_final_exam_at_1000(self):
        player = {'name': 'Irene', 'level': 1, 'intelligence': 1000, 'HP': 10, 'position': [3, 1], 'location': 'tech_hub',
                  'chocolate': 0}
        update_hp_based_on_intelligence_for_final_exam(player)
        actual = player['HP']
        expected = 3
    ...
    def test_update_hp_based_on_intelligence_for_final_exam_over_1000(self):
        player = {'name': 'Irene', 'level': 1, 'intelligence': 1500, 'HP': 10, 'position': [3, 1], 'location': 'tech_hub',
                  'chocolate': 0}
        update_hp_based_on_intelligence_for_final_exam(player)
        actual = player['HP']
        expected = 3
